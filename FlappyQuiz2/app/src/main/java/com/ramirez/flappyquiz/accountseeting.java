...
public class accountseeting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(accountseeting.this, String.valueOf(avatardef.getTag()), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (user != null) {
            for (UserInfo profile : user.getProviderData()) {
                ...
                Toast.makeText(this, "Welcome " + avatardef.getTag(), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void completeProfile() {
        ...
        if (avatardef.getTag() == "milk"){
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent intent
                                        = new Intent(accountseeting.this,
                                        mission.class);
            ...
            databaseReference.child("user").child(String.valueOf(fullname.getText().toString())).child("username").setValue(username.getText().toString());
            databaseReference.child("user").child(String.valueOf(fullname.getText().toString())).child("proglang").setValue(preflang.getText().toString());
